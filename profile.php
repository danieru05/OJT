                                    ...
                                    <div class="shadow mb-5 rounded" style="height: 65vh; overflow-y: auto;">
                                        <div class="tab-content mb-2" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="notif-tab-pane" role="tabpanel" aria-labelledby="notif-tab" tabindex="0">
                                                        ...
                                                        <div class="notify d-flex justify-content-between border-bottom p-3" style="text-align: justify;">
                                                            <p>
                            ...
                            <div class="row mb-4 g-5 h-100">
                                ...
                                <div class="col-md-6 p-4 rounded shadow">
                                    <div class="date row g-2 mb-2" style="font-size: 17.5px;">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" id="datetime" onchange="date()" style="color: #df7630; font-weight: bold;">
                                        </div>
                                    </div>
                                    <script> 
                                        $( function() {
                                            $('#datetime').datepicker({ //code for the datepicker and its format
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php
                                            // babasahin lahat ng data sa database and at the same time, iooutput ito.
                                            $sql = "SELECT * FROM categ";
                                            $result = mysqli_query($conn,$sql);
                            
                                            // loop na mag ooutput ng mga data sa database
                                    ...
                                    <div class="appoint mt-2">
                                        <div id=<?php echo $row["categ"]; ?> class="opt mt-2" style="margin-bottom: 2.5rem;">
                                            <h5 class="fw-bold"><?php echo $row["categ"]; ?></h5>
                                            <div class="d-flex justify-content-between border-bottom mb-3">
                                                <div>
                                                    <div id="what"><?php echo $row["names"]; ?></div>
                                                    <div><?php echo $row["avail"]; ?> available</div>
                                                </div>
                                                <div>
                                        ...
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                                            <div class="modal-body">
                                                <div class="p-3 border rounded mb-4">
                                                    <div class="row mb-0" style="font-size: 17.5px;">
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control-plaintext" name="pangalan" style="background-color: white; font-weight: bold;" value="Surname, First Name M.I" readonly>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control-plaintext" style="background-color: white; color:#df7630;" value="name.surname@cvsu.edu.ph" readonly>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control-plaintext" name="identity" style="background-color: white; font-weight: bold;" value="201810888" readonly>
                                                        </div>
                                                    </div>
                                                    <p style="text-align: justify; margin-bottom: 0;"> 
                                                        <button class="rounded-pill border-0 me-2" style=" color: white; background-color: #df7630; cursor: context-menu;">
                                                ...
                                                <div class="mb-3 border-bottom">
                                                    <div class="row mb-0" style="font-size: 22.5px;">
                                                        <label for="inputPassword" class="col-sm-2 col-form-label">Booked:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control-plaintext" id="tile" style="background-color: white; font-weight: bold;" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row" style="font-size: 22.5px;">
                                                        <label for="categ" class="col-sm-2 col-form-label"></label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control-plaintext" id="categ" style="background-color: white; font-weight: bold;" name="categ" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            
                                                <div class="row g-2 mb-2" style="font-size: 20px;">
                                                    <div class="row">
                                                        <label for="inputPassword" class="col-sm-2 col-form-label"><i class="bi bi-calendar-event-fill me-2"></i>Date:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control-plaintext" id="date" style="background-color: white; font-weight: bold;" name="date" readonly
                                                            value=" <?php date_default_timezone_set('Asia/Manila'); echo date('l, j F Y');?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <form class="needs-validation" novalidate>
                                                    <div class="row g-2 mb-3">
                                                        ...
                                                        <textarea class="purpose col-md-9 form-control" id="borrow-request" name="purpose" style="resize: none; height: 100px" required></textarea>
                                                        <div class="invalid-feedback">Please input your purpose for the appointment</div>
                                                    </div>
                                                    <div class="d-flex justify-content-end">
                                                        <button class="send-req btn rounded-pill border-0 me-2" name="send" type="submit" style="color: white; background-color: #df7630; font-size: 17.5px;">Send Request</button>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <?php 
                                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                    if(isset($_POST['send'])){
                                                        $ids = mysqli_real_escape_string($conn, $_POST['identity']);
                                                        $names = mysqli_real_escape_string($conn, $_POST['pangalan']);
                                                        $categ = mysqli_real_escape_string($conn, $_POST['categ']);
                                                        $date = mysqli_real_escape_string($conn, $_POST['date']);
                                                        $purpose = mysqli_real_escape_string($conn, $_POST['purpose']);
                                                            
                                                        //gumagawa ng query na mag iinsert ng mga values na ininput sa database
                                                        $que = "INSERT INTO booking(id,names,categ,dates,purpose) values('$ids','$names','$categ','$date','$purpose')";
                                                            
                                                        //ipapasa na yung query para magawa na sa database
